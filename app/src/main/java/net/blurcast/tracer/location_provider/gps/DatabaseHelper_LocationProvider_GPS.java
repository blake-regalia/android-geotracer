...
import net.blurcast.tracer.activity.ServiceControlActivity;
...
public class DatabaseHelper_LocationProvider_GPS extends SQLiteOpenHelper {
	
	private static final String DATABASE_NAME = "locationProvider_GPS";
	...
	public DatabaseHelper_LocationProvider_GPS(Context context) {
